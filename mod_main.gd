...
##	Text.keys_needing_operator.bm_stats_next_wave_chance = [0]
	...
	temp.health = 1												# 15
	temp.health_increase_each_wave = 9.0	# 4.0
...
##	# (Leaving only 28x6.5 Fins)
	...
	temp.value = -6
	temp.key = "stat_percent_damage"	# -3 HP Regen -> -6 Damage%
	...
	temp.effects.insert(1, temp_2)
	temp = load("res://items/all/bandana/bandana_effect_2.tres")
	temp.value = -8		# -10 (-Damage%)
	...
	temp = load("res://items/all/barricade/barricade_effect_1.tres")
	temp.value = 10		# 8
	temp = load("res://items/all/barricade/barricade_effect_2.tres")
	temp.value = -3		# -5 (Speed)
...
#	temp.effects.insert(1, temp_2)
	...
	temp.scaling_stats = [ [ "stat_engineering", 1.0 ], [ "stat_elemental_damage", 1.0 ] ]	# 0.9, 0.9
	...
	temp = load("res://items/all/warrior_helmet/warrior_helmet_data.tres")
	temp.value = 82		# 80
	...
	# Scapegoat
	temp = load("res://items/all/scapegoat/scapegoat.tres")
	temp.value = 100	# 110
...
#	temp.knockback_piercing = 0.35	# 0
	...
	temp.scaling_stats = [ [ "stat_ranged_damage", 2.5 ], [ "stat_range", 0.2 ] ]  # 1.0 / 0.2
	...
	temp.crit_chance = 0.25	# 0.2
	temp.scaling_stats = [ [ "stat_ranged_damage", 3.5 ], [ "stat_range", 0.3 ] ]  # 1.0 / 0.3
...
#	temp.value = 95					# 105
	...
	temp.value = 120 # 125 (Damage vs Bosses)
	temp = load("res://items/characters/jack/jack_effect_3.tres")
	temp.value = 180 # 175 (Enemy HP)
	...
	temp.value = 60		# 100 (Starting Luck)
